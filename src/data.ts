...
export const LAST_UPDATED = "2025-12-23T12:28:45.351Z";

export const INITIAL_CONFIG: GlobalConfig = {
  "resumeUrl": "/resume.pdf",
  "email": "hello@mukhianik.com",
  "heroHeadline": "UI/UX Desginer\n& Vibe Coder  \n\n",
  ...
  },
  {
    ...
    "content": [
      ...
      },
      {
        "id": "2",
        "type": "paragraph",
        "content": "The Baltimore Ravens Stadium Suite Tablet Experience was designed to enhance the luxury suite environment by offering guests an intuitive digital platform."
      }
    ]
  },
  {
    ...
    "content": [
      ...
      },
      {
        "id": "2",
        "type": "paragraph",
        "content": "Apex Global manages thousands of shipments daily. Their existing tools were fragmented, leading to operational inefficiencies. We built a unified dashboard to centralize tracking."
      },
      {
        "id": "3",
        "type": "h2",
      ...
      },
      {
        "id": "4",
        "type": "paragraph",
        "content": "• Real-time map visualization of assets\n• Automated delay risk alerts\n• One-click document generation"
      },
      {
        "id": "5",
        "type": "image",
        "content": "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=2070&auto=format&fit=crop",
        "caption": "Shipment Detail View"
      }
    ]
  },
  {
...
export const SOCIALS: SocialLink[] = [
  ...
  },
  {
    "id": "email-link",
    "platform": "Email",
    "url": "mailto:hello@mukhianik.com",
