...
`;
        ...
        if (!getResponse.ok) {
            throw new Error(getResponse.status === 404 ? 'Repository or file not found.' : 'Failed to fetch current file info.');
        }
        ...
        alert("Successfully committed to GitHub! Vercel should start rebuilding your site now.");
